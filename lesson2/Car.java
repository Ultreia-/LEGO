...
public class Car 
{
    ...
    public static void run(int leftPower, int leftCommand, int rightPower, int rightCommand)
    {
	    leftMotor.controlMotor(leftPower,leftCommand);
	    rightMotor.controlMotor(rightPower,rightCommand);
    }
